...
Алгоритм решения Создать класс Name. Добавить свойства surname, firstName, patronymic. Создать конструктор, который принимает любые параметры, некоторые могут быть null. В toString() формировать строку: пропуская те части, которые не заданы. В main создать: "Клеопатра" "Пушкин Александр Сергеевич" "Маяковский Владимир"
